        ...
        <Routes>
            ...
            <Route element={<ProtectedRoute />}>
                <Route element={<MainLayout />}>
                    ...
                    <Route
                        element={
                            <RoleProtectedRoute allowedRoles={["ADMIN", "ADMIN_LIBRARY"]} />
                        }
                    >
                    ...
                    <Route
                        element={
                            <RoleProtectedRoute allowedRoles={["ADMIN", "ADMIN_FINANCE"]} />
                        }
                    >
                        <Route
                            path="/admin/finance/structures"
                            element={<ManageFeeStructuresPage />}
                        />
                        <Route
                            path="/admin/finance/invoices/generate"
